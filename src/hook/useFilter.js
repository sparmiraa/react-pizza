...
export const useFilter = () => {
  ...
  useEffect(() => {
    ...
    const sortProperty = searchParams.get("sortProperty") || SORT_OPTIONS[0].sortProperty;
    const search = searchParams.get("search") || "";
  
    const sort = SORT_OPTIONS.find(obj => obj.sortProperty === sortProperty) || SORT_OPTIONS[0];
